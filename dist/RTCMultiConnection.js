...
var RTCMultiConnection = function(roomid, forceOptions) {
    ...
    function setCordovaAPIs() {
        ...
        navigator.mediaDevices.getUserMedia = navigator.webkitGetUserMedia = iosrtc.getUserMedia;
    ...
    function getUserMediaHandler(options) {
        ...
        if (currentUserMediaRequest.streams[idInstance]) {
            ...
            if (isBlackBerry || typeof navigator.mediaDevices === 'undefined' || typeof navigator.mediaDevices.getUserMedia !== 'function') {
                ...
                navigator.mediaDevices.getUserMedia(options.localMediaConstraints, function(stream) {
            ...
            if (typeof navigator.mediaDevices === 'undefined') {
                ...
                navigator.mediaDevices = {
                    getUserMedia: function(hints) {
                        navigator.mediaDevices.getUserMedia(hints, function(getUserMediaSuccess) {
